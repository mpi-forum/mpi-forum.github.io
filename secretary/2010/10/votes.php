...
ballot(ticket(228, "MPIR Specification - An Official Companion Document for the MPI Standard", 1),
       16, 0, 5, 0);

ballot(ticket(109, "Nonblocking Collective Operations (integration into MPI-3 latex)", 2),
       17, 0, 4, 0);
