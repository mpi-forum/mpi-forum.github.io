...
Voting is now open for the September 2022 Plenary Day 1 meeting. You may vote at this
link:
<br><br>
{link}
<br><br>
...
<br><br>
Voting will be open until 12:45pm US Central time on September 28th, 2022.
<br><br>
Thanks,
<br>
Wes Bland (MPI Forum Secretary)\
            ...
            message = service.create_message(from_addr='"MPI Forum Mailer Bot" <mpiforumbot@gmail.com>',
                    to_addr=email, msg=message_text, subject='September 2022 MPI Forum Plenary Day 1 Voting Link')
